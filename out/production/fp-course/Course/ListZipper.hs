...
-- >>> instance Arbitrary a => Arbitrary (ListZipper a)
-- where arbitrary = do l <- arbitrary; x <- arbitrary; r <- arbitrary; P.return (ListZipper l x r)
...
-- This implementation "visits" every possible zipper value derivable
-- from a given zipper (i.e. all zippers to the left and right).
--
